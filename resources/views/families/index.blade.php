            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">Create family</h3>
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="/families" method="post" id="createFamily">
                            <!-- text input -->
                            {{ csrf_field() }}
                    ...
                    <div class="box-footer">
                        <button class="btn btn-primary" onclick="document.getElementById('createFamily').submit();" type="submit">Create</button>
                    </div>
                </div>
